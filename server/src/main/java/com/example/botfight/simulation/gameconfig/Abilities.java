...
public final class Abilities {
    ...
    public static final Map<Integer, AbilityDefinition> CATALOG = Map.ofEntries(
            ...
            Map.entry(3, new AbilityDefinition(1_000, 0, 500, 0, 0, 700, 0,
                    ...
                    linearFalloff(15, 5, 100, 700), null, Map.of())),
            ...
            Map.entry(6, new AbilityDefinition(9_600, 400, 1_200, 1_200, 10, 184, 100,
                    0, 0, 0, ActivationModel.IMMEDIATE, ResourceModel.NONE, FalloffMode.CONTINUOUS,
                    List.of(), null, Map.of())),
            ...
            Map.entry(11, new AbilityDefinition(10_000, 0, 300, 20_800, 25, 87.5, 0,
                    0, 0, 0, ActivationModel.CONFIGURED, ResourceModel.NONE, FalloffMode.CONTINUOUS,
                    List.of(new DamageAnchor(0, 25)), null,
            ...
            Map.entry(12, new AbilityDefinition(400, 0, 300, 0, 0, 500, 0,
                    10, 3_000, 0, ActivationModel.CONFIGURED, ResourceModel.RELOAD_WHEN_EMPTY, FalloffMode.CONTINUOUS,
            ...
            Map.entry(25, new AbilityDefinition(1_500, 0, 300, 0, 15, 100, 0,
                    0, 0, 0, ActivationModel.CONFIGURED, ResourceModel.NONE, FalloffMode.CONTINUOUS,
                    List.of(), null, Map.of("hitboxWidth", 60.0))),
