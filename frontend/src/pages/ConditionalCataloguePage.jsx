...
import { STATE_VARIABLES } from "../logic/BotBrain";
...
function targetRule(variable) {
    ...
    if (variable.fighterTargetOnly) return "Opponent only";
...
export default function ConditionalCataloguePage() {
    ...
    return (
        <main className="conditional-catalogue min-h-screen bg-[#050d16] font-interface text-slate-100">
            ...
            <div className="mx-auto grid max-w-[92rem] gap-10 px-5 py-10 sm:px-8 sm:py-14 lg:grid-cols-[15rem_minmax(0,1fr)_minmax(18rem,22rem)]">
                <aside className="self-start border border-blue-500/40 bg-[#081522]/85 p-5">
                    ...
                    <p className="mt-3 text-sm leading-6 text-slate-400">
                        Create a number or boolean variable in the bot brain workspace and give it an initial value. It then appears in conditional value pickers, so you can compare it just like the built-in values listed here.
                    </p>
                    <p className="mt-3 text-sm leading-6 text-slate-400">
                    ...
                    <p className="mt-3 text-sm leading-6 text-slate-400">
                        <strong className="text-slate-200">Chosen target</strong> can read the opponent or an entity created by either fighter's drafted abilities.
                    </p>
                    <p className="mt-3 text-sm leading-6 text-slate-400">
