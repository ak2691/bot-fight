...
export const ABILITY_CATALOGUE_PHASES = Object.freeze({
    ...
    9: Object.freeze([section("Active phase",
        ["Damage", "20"], ["Range", "500 units"], ["Hitbox width", "5 units"], ["Preparation", "1 sec"], ["Status effect", "Slow (3 sec)"])]),
    ...
    11: Object.freeze([
        ...
        section("Impact phase", ["Radius", "87.5 units"], ["Damage", "30"]),
    ]),
    ...
    26: Object.freeze([section("Active phase",
        ["Radius", "120 units"], ["Damage", "15"], ["Knockback", "60 units"], ["Status effect", "Slow (2 sec)"])]),
    27: Object.freeze([
    ...
    28: Object.freeze([
        section("Outbound phase",
            ["Hitbox width", "18 units"], ["Hitbox length", "18 units"], ["Range", "400 units"], ["Speed", "100 units per tick"], ["Damage", "10"], ["Status effect", "Slow (1.2 sec)"]),
        section("Return phase", ["Speed", "150 units per tick"], ["Pull strength", "150 units per tick"], ["Pull duration", "2 ticks"]),
    ]),
    29: Object.freeze([
        section("Armed phase", ["Radius", "75 units"], ["Damage", "25"], ["Status effect", "Slow (2.2 sec)"]),
        section("On destruction", ["Radius", "120 units"], ["Damage", "40"], ["Status effect", "Slow (3 sec)"]),
    ]),
    30: Object.freeze([section("Active phase",
        ["Damage", "20"], ["Range", "600 units"], ["Hitbox width", "8 units"], ["Interrupt", "250 ms"], ["Status effect", "Slow (1.5 sec)"])]),
