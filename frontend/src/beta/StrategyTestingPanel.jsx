...
export default function StrategyTestingPanel({
    configuration,
    onChange,
            ...
            <div className="space-y-4">
                ...
                {isMatchTesting && (
                    <section className="rounded-xl border border-slate-600/70 bg-slate-900/55 p-4 text-[10px] shadow-[0_10px_30px_rgba(0,0,0,.2)]">
                        ...
                        {testingRemaining === 0 && finishStatus === "TESTING" && (
                ...
                <section className="rounded-xl border border-slate-600/70 bg-slate-900/55 p-4 shadow-[0_10px_30px_rgba(0,0,0,.2)]">
                    ...
                    <div className="grid grid-cols-4 gap-2.5">
                        ...
                        {!isMatchTesting && (
                            ...
                            <ControlButton icon="target" onClick={onSpawnOpponent} disabled={!onSpawnOpponent || isTesting || isAutoPlaying} tone="violet">
                                SPAWN OPPONENT
                            </ControlButton>
                        ...
                        <ControlButton
                            ...
                            disabled={!onSaveArenaCheckpoint || isBaseTesting || isTesting || isAutoPlaying}
                            tone="amber"
                        >
                            SAVE POINT
                        </ControlButton>
                        <ControlButton
                            ...
                            disabled={!onResetArenaCheckpoint || isBaseTesting || isTesting || !hasArenaCheckpoint}
                            tone="neutral"
                        >
                            LOAD POINT
                        </ControlButton>
                        <ControlButton
                            ...
                            disabled={!onFullArenaReset || isBaseTesting || isTesting}
                            tone="red"
                        >
                            RESET TO BEGINNING
                        </ControlButton>
                        {isMatchTesting ? (
                            ...
                            <ControlButton
                                ...
                                tone="red"
                            >
                                {finishStatus === "SURRENDERING" ? "SURRENDERING" : "GIVE UP"}
                            </ControlButton>
                            </>
                        ) : null}
                    </div>
                ...
                <div className="fixed inset-0 z-40 flex items-center justify-center bg-black/70 px-4 py-5">
                    <section className="brain-workspace relative flex h-[min(90vh,820px)] w-[min(94vw,1440px)] flex-col overflow-hidden rounded-sm border border-border-mid bg-[#111519] shadow-2xl">
                        ...
                        <TreeLogicBoard
                                ...
                                canUndo={!isTesting && editHistory[activeBrain].undo.length > 0}
                                canRedo={!isTesting && editHistory[activeBrain].redo.length > 0}
