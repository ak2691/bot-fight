...
const BOT_ABILITY_CATALOG = [
    ...
    { id: 9, round: 1, visualInterpolation: "none", summary: "Charge a 20-damage shot that slows its target for 3 seconds." },
    ...
    { id: 26, round: 1, visualInterpolation: "none", summary: "Blast a 120-unit frost ring that deals damage, knockback, and a 2-second slow." },
    ...
    { id: 29, round: 1, visualInterpolation: "linear", summary: "Place a destructible 16-second snare that deals 25 damage on contact or 40 damage when destroyed, with a stronger explosion on destruction." },
    { id: 30, round: 2, visualInterpolation: "none", summary: "Charge a 20-damage dart that interrupts and slows its target for 1.5 seconds." },
