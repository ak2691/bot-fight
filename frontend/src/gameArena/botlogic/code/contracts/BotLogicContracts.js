...
export const STATE_VARIABLE_SOURCES = Object.freeze({
    ...
    SELECTABLE_DANGER_ZONE_EDGE_DISTANCE: "selectableDangerZoneEdgeDistance",
...
const GENERIC_ABILITY_VARIABLES = [
    ...
    ["selectedAbilityPreparationMs", "Ability Preparation Time Left", "number", STATE_VARIABLE_SOURCES.SELECTED_ABILITY_PREPARATION_MS, { min: 0, max: 10, unit: "seconds", step: 0.1, requiredTag: "wind-up" }],
...
export const STATE_VARIABLES = Object.freeze([
    ...
    variableDefinition("selectable.x", "Entity X Position", "number", { group: "Position & Movement", min: 0, max: ARENA_WIDTH_UNITS, unit: "arena units", supportsSelectable: true, scope: STATE_VARIABLE_SCOPES.SELECTABLE, runtimeSource: STATE_VARIABLE_SOURCES.SELECTABLE_X }),
    variableDefinition("selectable.y", "Entity Y Position", "number", { group: "Position & Movement", min: 0, max: ARENA_HEIGHT_UNITS, unit: "arena units", supportsSelectable: true, scope: STATE_VARIABLE_SCOPES.SELECTABLE, runtimeSource: STATE_VARIABLE_SOURCES.SELECTABLE_Y }),
